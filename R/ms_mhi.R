...
mhi1=codemog_api(data="b19013",db="acs1115", geonum=paste("1", state, fips, sep=""), meta="no")%>%
...
mhi2=codemog_api(data="b19013",db="acs1115", geonum=paste("1", state2, fips2, sep=""), meta="no")%>%
  mutate(geoname=str_trim(geoname, side="both"),

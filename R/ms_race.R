...
ms_race=function(fips, state="08"){
  ...
  p4_00=p4_00%>%
    ...
    mutate(TotalPop=p4001, Hispanic=p4002, NonHispanic=p4003, NHWhite=p4005, NHBlack=p4006,
           ...
           NHAIANP=percent(round(NHAIAN/NonHispanic,3)),
           NHAsianP=percent(round(NHAsian/NonHispanic,3)),
           NHNHOPIP=percent(round(NHNHOPI/NonHispanic,3)),
           NHOtherP=percent(round(NHOther/NonHispanic,3)),
           NHTwoP=percent(round(NHTwo/NonHispanic,3)),

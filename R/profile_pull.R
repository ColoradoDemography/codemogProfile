...
incdist=ms_income(fips=fips, fips2=fips2, state=state, state2=state2)+theme(legend.key.size=unit(1, "mm"), legend.margin=unit(0, "mm"), panel.margin=unit(0, "mm"))
...
popchart=muni_ts_chart(fips)+theme(legend.key.size=unit(1, "mm"), legend.margin=unit(0, "mm"), panel.margin=unit(0, "mm"))
ggsave(filename=paste0("popchart_",fips,".png"), popchart, path=od)
